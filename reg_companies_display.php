            ...
            <div class="col-md-12">
                <div class="card mt-4">
                    <div class="card-header">
                        <h4> Search box -Registered Company wise </h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <form action="" method="GET">
                                    <div class="input-group mb-3">
                                        ...
                                        <button type="submit" class="btn btn-primary">Search</button>  <a href="company_reg.html" class="btn btn-primary" >BACK</a>
                                    </div>
                                </form>
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT * FROM company WHERE CONCAT(companyreg,date,package,rounds,round1,round2,round3,round4,round5,round6,branch) LIKE '%$filtervalues%' ";
...
?>
  <tr>
    ...
    <td><?php echo $data['round1']; ?></td>
    <td><?php echo $data['round2']; ?></td>
    <td><?php echo $data['round3']; ?></td>
    <td><?php echo $data['round4']; ?></td>
    <td><?php echo $data['round5']; ?></td>
    <td><?php echo $data['round6']; ?></td>

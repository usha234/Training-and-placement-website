...
<main>
  ...
  <html>
    ...
    $sql = $db->prepare("SELECT count(*) FROM final_select where companyreg = 'wipro' ");
    $sql1 = $db->prepare("SELECT count(*) FROM final_select where companyreg = 'infosis' ");
    $sql2 = $db->prepare("SELECT count(*) FROM final_select where companyreg = 'accenture' ");
    $sql3 = $db->prepare("SELECT count(*) FROM final_select where companyreg = 'epam' ");
    $sql4 = $db->prepare("SELECT count(*) FROM final_select where companyreg = 'tcs' ");
    $sql5 = $db->prepare("SELECT count(*) FROM final_select where companyreg = 'coginizant' ");
    $sql6 = $db->prepare("SELECT count(*) FROM final_select where companyreg = 'amazon' ");
    
      $sql->execute();
      $rows = $sql->fetch(PDO::FETCH_NUM);
      $numberofrowswipro=$rows[0];
    
        $sql1->execute();
      $rows = $sql1->fetch(PDO::FETCH_NUM);
      $numberofrowsinfosis=$rows[0];
    
        $sql2->execute();
      $rows = $sql2->fetch(PDO::FETCH_NUM);
      $numberofrowsaccenture=$rows[0];
    
        $sql3->execute();
      $rows = $sql3->fetch(PDO::FETCH_NUM);
      $numberofrowsepam=$rows[0];
    
        $sql4->execute();
      $rows = $sql4->fetch(PDO::FETCH_NUM);
      $numberofrowstcs=$rows[0];
    
        $sql5->execute();
      $rows = $sql5->fetch(PDO::FETCH_NUM);
      $numberofrowscognizant=$rows[0];
    
        $sql6->execute();
      $rows = $sql6->fetch(PDO::FETCH_NUM);
      $numberofrowsamazon=$rows[0];
    
       
      echo 'Wipro : '.$numberofrowswipro;
        echo 'infosis : '.$numberofrowsinfosis;
        echo 'Accenture : '.$numberofrowsaccenture;
      echo 'Epam : '.$numberofrowsepam;
        echo 'Cognizant : '.$numberofrowscognizant;
        echo 'TCS : '.$numberofrowstcs;
        echo 'Amazon : '.$numberofrowsamazon;
    ...
    <table class="graph">
      ...
      <thead>
        ...
        <tr style="height:<?php echo $numberofrowswipro ?>%">
          <th scope="row">Wipro</th>
          <td><span><?php echo $numberofrowswipro ?>%</span></td>
        </tr>
        <tr style="height:<?php echo $numberofrowsinfosis ?>%">
          <th scope="row">Infosis</th>
          <td><span><?php echo $numberofrowsinfosis ?>%</span></td>
        </tr>
        <tr style="height:<?php echo $numberofrowsaccenture ?>%">
          <th scope="row">Accenture</th>
          <td><span><?php echo $numberofrowsaccenture ?>%</span></td>
        </tr>
        <tr style="height:<?php echo $numberofrowsepam ?>%">
          <th scope="row">Epam</th>
          <td><span><?php echo $numberofrowsepam ?>%</span></td>
        </tr>
        <tr style="height:<?php echo $numberofrowscognizant ?>%">
          <th scope="row">Cognizant</th>
          <td><span><?php echo $numberofrowscognizant ?>%</span></td>
        </tr>
        <tr style="height:<?php echo $numberofrowstcs ?>%">
          <th scope="row">TCS</th>
          <td><span><?php echo $numberofrowstcs ?>%</span></td>
        </tr>
        <tr style="height:<?php echo $numberofrowsamazon ?>%">
          <th scope="row">Amazon</th>
          <td><span><?php echo $numberofrowsamazon ?>%</span></td>
        </tr>

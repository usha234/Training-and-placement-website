...
<form action="ment2.php" method="POST" autocomplete="off">
    <div class="container-fluid my-3 mx-2">
    <h1 class="h3 mb-3 fw-normal">Mentor Registration</h1>
  
      <div class="mb-3" >
        <input type="text" class="form-control" id="floatingInput" name="roll" size="25" id="roll" placeholder="Enter id">

      </div>
      <div class="mb-3">
          <input type="text" class="form-control" id="floatingInput" name="name" size="25" id="date" placeholder="Enter name">
      </div>

      <div class="mb-3">
        <input type="text" class="form-control" id="floatingInput" name="qua" size="25" id="eamcet" placeholder="Enter your highest Qualification">
    </div>
</div>
  ...
  <div class="row my-3 mx-2">
    ...
    <div class="col col-lg-6">
      <input type="submit" class="form-control btn btn-md btn-dark" name="submit">
    </div>
  </div>
      </div>
    </form>

...
echo $id = $_GET['id'];
$select = "select * from nin where id='$id'";
...
?>
  ...
  <div class="row my-3 mx-2">
    ...
    <div class="col col-lg-6">
      ...
      <button><a href="stusample.php">Back</a></button>
    </div>
  </div>
      </div>
...
if(isset($_POST['update_btn'])){
  ...
  $backlogs=$_REQUEST['backlogs'];
    ...
    $update= "update nin set roll='$roll',name='$name',ssc='$ssc',inter='$inter',eamcet='$eamcet',percentage='$percentage',backlogs='$backlogs',gender='$gender',stay='$stay',board='$board',loca='$loca' where id='$id'";

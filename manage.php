...
<html lang="en">
  ...
  .bd-placeholder-img {
      ...
      section {
  margin-top: 20px; /* increase the distance from the nav bar */
  display: flex;
  justify-content: center; /* center the images horizontally */
}

.col {
  margin-left: 20px; /* increase the distance between the images */
  margin-right: 20px; /* increase the distance between the images */
}
...
<!-- <button type="button" class="btn btn-dark btn-lg mr-2  " ><a href="manage1.php" class="text-light"><td><?php //echo $arraydata['companyreg']; ?> </td></a></button> -->
...
$n=$_REQUEST['date'];
// echo "<input type='date' name='yt' value='".$n."' style='display:none'>";
echo "The Registered Company's on this $n  are";
echo nl2br("\n");
...
echo "<form action='manage1.php' method='post'>";

  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Insert branch data</h1>
...
<br>
<br>
<input type="text" class="form-control mb-3" name="mytext[]" placeholder="Enter branch">
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <label for="">Enter branch</label>
            <input type="text" name="B" id="b" class="form-control" placeholder='branch'>
             <input type="text" name="C" id="c" class="form-control " style="display:none" placeholder='branch'>
        </div>
      </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="text" name="D" id="d" class="form-control" placeholder='branch'>
...
<!-- modal container -->
 <div class="container my-5">
    <div class="row">
        <div class="col-md-12">
            <div class="card" style="background:transparent; backdrop-filter: blur(15px);
    display: flex;">
    ...
    if(mysqli_num_rows($g)>0){
       while($r=mysqli_fetch_array($g)){
        ...
        <tr>
            ...
            <td>  </td>
            <td></td>
            <td class='st-i  justify-content-center align-content-center'><h5><?php echo $r['branch'];?></h5></td>
            <td></td>
            <td >
              <div>

...
">
    ...
    <!-- <video class="qubely-video-bg" autoplay muted loop><source src="vid3.mp4"/></video> -->
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Insert company data</h1>
...
<br>
<br>
<input type="text" class="form-control mb-3" name="mytext[]" placeholder="Enter company name">
</div>
...
$(document).ready(function() {
    ...
    e.preventDefault();
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div class="input-group mb-3"><input placeholder="Enter company name" type="text" name="mytext[]" class="form-control"><input type="text" value="' + x + '" name="co"  style="display:none"><div class="input-group-append"><button class="btn btn-outline-danger remove_field" type="button">Remove</button></div></div>'); //add input box
        }
    });
...
<div class="modal fade" id="edit" tabindex="-1" aria-labelledby="editLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="coupdate.php" method="post">
      <div class="modal-body">
        ...
        <label for="">Enter the Company</label>
            <input type="text" name="B" id="b" class="form-control" placeholder='Company'>
             <input type="text" name="C" id="c" class="form-control " style="display:none" placeholder='Company'>
        </div>
      </div>
...
<div class="modal fade" id="delete" tabindex="-1" aria-labelledby="deleteLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form action="codelete.php" method="post">
      <div class="modal-body">
        <strong><h1>Do you want to delete...????</h1></strong>
        <div class="form-group">
        
        <input type="text" name="D" id="d" class="form-control" placeholder='Company'>
                ...
                if(isset($_SESSION['status']) && $_SESSION['status']!=''){
                    ?>
                     <div class="alert alert-info alert-dismissible   fade show" role="alert">
                      ...
                      <button formaction="company_regis.php" type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                       </div>                 
    ...
    if(mysqli_num_rows($g)>0){
       while($r=mysqli_fetch_array($g)){
        ...
        <tr>
            ...
            <td>  </td>
            <td></td>
            <td class='st-i  justify-content-center align-content-center'><h5><?php echo $r['companyreg'];?></h5></td>
            <td></td>
            <td >
              <div>
...
<button type="submit" name='n' class="btn btn-outline-info"><a href="company_regis.php">Nothing to add</a></button
